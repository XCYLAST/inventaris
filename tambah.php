...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = $dbconnect->prepare("INSERT INTO inventaris_barang (tanggal, kode_barang, nama_barang, uraian_barang, distributor, kwantitas, tahun, asal_barang, tgl_perolehan, keadaan_barang, harga, keterangan) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
