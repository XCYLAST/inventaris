...
<body class="container mt-4">
    <h2 class="text-center mb-4">Inventaris buku</h2>
    <a href="tambah.php" class="btn btn-outline-warning mb-3">Tambah Data</a>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='edit.php?id=" . $row['id'] . "' btn-sm'>Edit</a> <a href='hapus.php?id=" . $row['id'] . "'  btn-sm'>Hapus</a></td>";
                    echo "</tr>";
                }
            } else {
