...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    // Fetch data by ID
    $query = "SELECT * FROM inventaris_barang WHERE id = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE inventaris_barang SET tanggal='$tanggal', kode_barang='$kode_barang', nama_barang='$nama_barang', distributor='$distributor', kwantitas=$kwantitas, tahun=$tahun, asal_barang='$asal_barang', tgl_perolehan='$tgl_perolehan', keadaan_barang='$keadaan_barang', harga=$harga, keterangan='$keterangan' WHERE id=$id";
